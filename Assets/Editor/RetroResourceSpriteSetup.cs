...
public static class RetroResourceSpriteSetup
{
    ...
    {
        "Assets/Sprites/Resources/World/World_Apple.png",
        "Assets/Sprites/Resources/World/World_Mushroom.png",
        "Assets/Sprites/Resources/World/World_SpecialWeedPlant.png",
        "Assets/Sprites/Resources/World/World_WoodStump.png",
        "Assets/Sprites/Resources/World/World_StoneCluster.png"
    };

    private static readonly string[] IconSpritePaths =
    {
        "Assets/Sprites/Resources/Icons/Icon_Apple.png",
        "Assets/Sprites/Resources/Icons/Icon_Mushroom.png",
        "Assets/Sprites/Resources/Icons/Icon_SpecialWeed.png",
        "Assets/Sprites/Resources/Icons/Icon_Wood.png",
        "Assets/Sprites/Resources/Icons/Icon_Stone.png"
    };

    private static readonly string[] EmissionMapPaths =
    {
        "Assets/Sprites/Resources/Maps/Emission_Apple.png",
        "Assets/Sprites/Resources/Maps/Emission_Mushroom.png",
        "Assets/Sprites/Resources/Maps/Emission_SpecialWeed.png",
        "Assets/Sprites/Resources/Maps/Emission_Wood.png",
        "Assets/Sprites/Resources/Maps/Emission_Stone.png"
    };

    private static readonly string[] PrefabPaths =
    {
        "Assets/Prefabs/Resources/ApplePickup.prefab",
        "Assets/Prefabs/Resources/MushroomPickup.prefab",
        "Assets/Prefabs/Resources/SpecialWeedPlant.prefab",
        "Assets/Prefabs/Resources/WoodStumpGatherable.prefab",
        "Assets/Prefabs/Resources/StoneClusterGatherable.prefab"
    };
    ...
    public static void Run()
    {
        ...
        EnsureFolder("Assets/Materials", "Resources");
        EnsureFolder("Assets/Sprites/Resources", "Maps");
        ...
        AssetDatabase.ImportAsset("Assets/Shaders/RetroResourceSpriteGlowHDRP.shader", ImportAssetOptions.ForceUpdate);
        Shader shader = AssetDatabase.LoadAssetAtPath<Shader>("Assets/Shaders/RetroResourceSpriteGlowHDRP.shader");
        if (shader == null)
        {
    ...
    public static void Verify()
    {
        ...
        for (int i = 0; i < ResourceNames.Length; i++)
        {
            ...
            Material material = AssetDatabase.LoadAssetAtPath<Material>($"Assets/Materials/Resources/{ResourceNames[i]}ResourceSprite.mat");
    ...
    private static Material CreateOrUpdateMaterial(int index, Shader shader)
    {
        ...
        string materialPath = $"Assets/Materials/Resources/{ResourceNames[index]}ResourceSprite.mat";
    ...
    private static void AssignSceneMaterials()
    {
        ...
        for (int i = 0; i < root.transform.childCount; i++)
        {
            ...
            Material material = AssetDatabase.LoadAssetAtPath<Material>($"Assets/Materials/Resources/{ResourceNames[resourceIndex]}ResourceSprite.mat");
