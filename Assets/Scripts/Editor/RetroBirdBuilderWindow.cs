...
{
    private const string DefaultPrefabPath = "Assets/Nature/Birds/SmallBird/Prefabs/SmallBird.prefab";
    ...
    {
        ("baseMap", "Assets/Nature/Birds/SmallBird/Textures/SmallBird_Atlas_Base.png"),
        ("normalMap", "Assets/Nature/Birds/SmallBird/Textures/SmallBird_Atlas_Normal.png"),
        ("thicknessMap", "Assets/Nature/Birds/SmallBird/Textures/SmallBird_Atlas_Thickness.png"),
        ("packedMasksMap", "Assets/Nature/Birds/SmallBird/Textures/SmallBird_Atlas_PackedMasks.png")
    };
    ...
    private static void ConfigureAgentDefaults(RetroFlockAgent agent, string groupId, Vector3 homePosition, Vector3 velocity)
    {
        ...
        SetFloat(serializedAgent, "wanderWeight", 0.55f);
...
public sealed class RetroBirdRendererEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            RetroBirdBuilderWindow.CreateOrReplacePrefab("Assets/Nature/Birds/SmallBird/Prefabs/SmallBird.prefab", true);
        }
    }
}
