...
{
    private const string DefaultPrefabPath = "Assets/Nature/Trees/HybridTree/Prefabs/HybridTree.prefab";
    ...
    {
        ("leafBaseMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Leaves_Base.png"),
        ("leafNormalMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Leaves_Normal.png"),
        ("leafDepthMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Leaves_Depth.png"),
        ("leafThicknessMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Leaves_Thickness.png"),
        ("leafDensityMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Leaves_Density.png"),
        ("leafWindMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Leaves_Wind.png"),
        ("barkBaseMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Bark_Base.png"),
        ("barkNormalMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Bark_Normal.png"),
        ("impostorBaseMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Impostor_Base.png"),
        ("impostorNormalMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Impostor_Normal.png"),
        ("impostorDepthMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Impostor_Depth.png"),
        ("impostorThicknessMap", "Assets/Nature/Trees/HybridTree/Textures/HybridTree_Impostor_Thickness.png")
    };
...
public sealed class RetroHybridTreeEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            RetroHybridTreeBuilderWindow.CreateOrReplacePrefab("Assets/Nature/Trees/HybridTree/Prefabs/HybridTree.prefab", true);
        }
    }
}
