...
{
    private const string BikeFramesFolderPath = "Assets/Sprites/NPCs/Motocross/Frames";
    private const string BikeGeneratedFolderPath = "Assets/Sprites/NPCs/Motocross/Generated";
    private const string BikePrefabPath = BikeGeneratedFolderPath + "/Motocross.prefab";
    private const string BikeAssetName = "Motocross";
    private const string MountedFramesFolderPath = "Assets/Sprites/NPCs/MotocrossMerchant/Frames";
    private const string MountedGeneratedFolderPath = "Assets/Sprites/NPCs/MotocrossMerchant/Generated";
    ...
    private const string FirstPersonFramesFolderPath = "Assets/Sprites/NPCs/Motocross/FirstPerson/Frames";
