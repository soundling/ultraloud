...
public sealed class DirectionalSpriteBillboardLitRenderer : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 2f)] private float normalScale = 0.9f;
    [SerializeField, Range(0f, 1f)] private float detailNormalInfluence = 0.48f;
    [SerializeField, Range(0f, 2f)] private float macroNormalBend = 0.55f;
    [SerializeField, Range(0f, 1f)] private float spriteAngleLightingInfluence = 0.28f;
    [SerializeField] private bool twoSidedLighting = true;
    [SerializeField] private bool flipBackfacingNormals = true;
    [SerializeField, Range(0f, 1f)] private float wrapDiffuse = 0.34f;
    ...
    [SerializeField, Range(0f, 1f)] private float surfaceRoughness = 0.94f;
    [SerializeField, Range(0f, 4f)] private float specularStrength = 0.025f;
    [SerializeField, Range(1f, 32f)] private float minSpecularPower = 8f;
    [SerializeField, Range(1f, 128f)] private float maxSpecularPower = 14f;
