...
{
    private const string HorseFramesFolderPath = "Assets/_Project/Art/Sprites/NPCs/Horse/Frames";
    private const string HorseGeneratedFolderPath = "Assets/_Project/Art/Sprites/NPCs/Horse/Generated";
    private const string HorsePrefabPath = HorseGeneratedFolderPath + "/Horse.prefab";
    private const string HorseAssetName = "Horse";
    private const string MountedFramesFolderPath = "Assets/_Project/Art/Sprites/NPCs/HorseMerchant/Frames";
    private const string MountedGeneratedFolderPath = "Assets/_Project/Art/Sprites/NPCs/HorseMerchant/Generated";
    ...
    private const string FirstPersonFramesFolderPath = "Assets/_Project/Art/Sprites/NPCs/Horse/FirstPerson/Frames";
    ...
    private static void ConfigureLitRenderer(DirectionalSpriteBillboardLitRenderer renderer, DirectionalSpriteAnimator animator, Renderer quadRenderer)
    {
        ...
        SetFloat(serialized, "macroNormalBend", 0.58f);
        ...
        SetFloat(serialized, "specularStrength", 0.04f);
        SetFloat(serialized, "rimStrength", 0.04f);
        SetFloat(serialized, "rimPower", 4f);
