...
{
    private const string DefaultPrefabPath = "Assets/_Project/Content/World/Buildings/SettlementHouse/Prefabs/SettlementHouse.prefab";
    ...
    {
        ("frontMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Front_Base.png"),
        ("frontMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Front_Normal.png"),
        ("frontMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Front_Height.png"),
        ("frontMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Front_PackedMasks.png"),
        ("frontMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Front_Emission.png"),

        ("sideMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Side_Base.png"),
        ("sideMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Side_Normal.png"),
        ("sideMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Side_Height.png"),
        ("sideMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Side_PackedMasks.png"),
        ("sideMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Side_Emission.png"),

        ("backMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Back_Base.png"),
        ("backMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Back_Normal.png"),
        ("backMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Back_Height.png"),
        ("backMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Back_PackedMasks.png"),
        ("backMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Back_Emission.png"),

        ("roofMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Roof_Base.png"),
        ("roofMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Roof_Normal.png"),
        ("roofMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Roof_Height.png"),
        ("roofMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Roof_PackedMasks.png"),
        ("roofMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Roof_Emission.png"),

        ("doorMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Door_Base.png"),
        ("doorMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Door_Normal.png"),
        ("doorMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Door_Height.png"),
        ("doorMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Door_PackedMasks.png"),
        ("doorMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Textures/SettlementHouse_Door_Emission.png"),

        ("interiorWallMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorWall_Base.png"),
        ("interiorWallMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorWall_Normal.png"),
        ("interiorWallMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorWall_Height.png"),
        ("interiorWallMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorWall_PackedMasks.png"),
        ("interiorWallMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorWall_Emission.png"),

        ("interiorFloorMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorFloor_Base.png"),
        ("interiorFloorMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorFloor_Normal.png"),
        ("interiorFloorMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorFloor_Height.png"),
        ("interiorFloorMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorFloor_PackedMasks.png"),
        ("interiorFloorMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorFloor_Emission.png"),

        ("interiorCeilingMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorCeiling_Base.png"),
        ("interiorCeilingMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorCeiling_Normal.png"),
        ("interiorCeilingMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorCeiling_Height.png"),
        ("interiorCeilingMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorCeiling_PackedMasks.png"),
        ("interiorCeilingMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorCeiling_Emission.png"),

        ("interiorDoorMaps.baseMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorDoor_Base.png"),
        ("interiorDoorMaps.normalMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorDoor_Normal.png"),
        ("interiorDoorMaps.heightMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorDoor_Height.png"),
        ("interiorDoorMaps.packedMasksMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorDoor_PackedMasks.png"),
        ("interiorDoorMaps.emissionMap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Textures/InteriorDoor_Emission.png")
    };
    ...
    {
        ("TornSofa", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/TornSofa", new Vector2(1.85f, 0.92f), new Vector2(0.9f, 1.18f), true, true),
        ("DirtyTable", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/DirtyTable", new Vector2(1.28f, 0.84f), new Vector2(0.85f, 1.16f), false, true),
        ("BrokenChair", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/BrokenChair", new Vector2(0.72f, 1.02f), new Vector2(0.82f, 1.15f), false, true),
        ("SmallStool", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/SmallStool", new Vector2(0.62f, 0.58f), new Vector2(0.75f, 1.1f), false, true),
        ("RottenCabinet", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/RottenCabinet", new Vector2(1.1f, 1.75f), new Vector2(0.86f, 1.12f), true, true),
        ("CrookedBookshelf", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/CrookedBookshelf", new Vector2(1.18f, 1.95f), new Vector2(0.82f, 1.08f), true, true),
        ("RustyStove", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/RustyStove", new Vector2(0.95f, 1.2f), new Vector2(0.86f, 1.08f), true, true),
        ("OilLamp", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/OilLamp", new Vector2(0.45f, 0.72f), new Vector2(0.8f, 1.25f), false, true),
        ("CrateStack", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/CrateStack", new Vector2(1.05f, 1.05f), new Vector2(0.85f, 1.2f), true, true),
        ("Barrel", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/Barrel", new Vector2(0.82f, 1.15f), new Vector2(0.85f, 1.2f), true, true),
        ("TrashBags", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/TrashBags", new Vector2(1.15f, 0.78f), new Vector2(0.82f, 1.25f), true, true),
        ("RolledRug", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/RolledRug", new Vector2(1.18f, 0.55f), new Vector2(0.85f, 1.28f), false, true),
        ("FilthyMattress", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/FilthyMattress", new Vector2(1.72f, 0.72f), new Vector2(0.88f, 1.18f), true, true),
        ("BrokenFrame", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/BrokenFrame", new Vector2(0.72f, 0.92f), new Vector2(0.82f, 1.14f), true, false),
        ("Bucket", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/Bucket", new Vector2(0.58f, 0.68f), new Vector2(0.82f, 1.22f), false, true),
        ("SideTableBottles", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Furniture/SideTableBottles", new Vector2(0.82f, 0.95f), new Vector2(0.82f, 1.18f), false, true)
    };

    private static readonly (string label, string folder, Vector2 size, Vector2 scaleRange)[] DirtDecals =
    {
        ("MudStain", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/MudStain", new Vector2(1.15f, 0.85f), new Vector2(0.8f, 1.45f)),
        ("OilStain", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/OilStain", new Vector2(1.05f, 0.8f), new Vector2(0.75f, 1.35f)),
        ("DustPile", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/DustPile", new Vector2(0.9f, 0.72f), new Vector2(0.75f, 1.3f)),
        ("GlassShards", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/GlassShards", new Vector2(0.8f, 0.72f), new Vector2(0.7f, 1.18f)),
        ("TornPapers", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/TornPapers", new Vector2(0.92f, 0.72f), new Vector2(0.75f, 1.25f)),
        ("ClothScrap", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/ClothScrap", new Vector2(0.96f, 0.72f), new Vector2(0.75f, 1.22f)),
        ("RubblePile", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/RubblePile", new Vector2(0.95f, 0.78f), new Vector2(0.78f, 1.28f)),
        ("SpilledAsh", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/SpilledAsh", new Vector2(1.05f, 0.75f), new Vector2(0.78f, 1.35f)),
        ("MoldPatch", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/MoldPatch", new Vector2(0.95f, 0.82f), new Vector2(0.75f, 1.28f)),
        ("Footprints", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/Footprints", new Vector2(1.05f, 0.85f), new Vector2(0.72f, 1.2f)),
        ("RopeCoil", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/RopeCoil", new Vector2(0.8f, 0.8f), new Vector2(0.75f, 1.18f)),
        ("SawdustPile", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/SawdustPile", new Vector2(1.05f, 0.72f), new Vector2(0.8f, 1.35f)),
        ("CrackedBoard", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/CrackedBoard", new Vector2(1.05f, 0.82f), new Vector2(0.75f, 1.25f)),
        ("TinyDebris", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/TinyDebris", new Vector2(0.85f, 0.7f), new Vector2(0.72f, 1.2f)),
        ("CircularRugStain", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/CircularRugStain", new Vector2(1.15f, 1.0f), new Vector2(0.78f, 1.32f)),
        ("BottleShards", "Assets/_Project/Content/World/Buildings/SettlementHouse/Interior/Props/Decals/BottleShards", new Vector2(0.82f, 0.72f), new Vector2(0.72f, 1.18f))
    };
...
public sealed class RetroHybridBuildingEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            RetroHybridBuildingBuilderWindow.CreateOrReplacePrefab("Assets/_Project/Content/World/Buildings/SettlementHouse/Prefabs/SettlementHouse.prefab", true);
        }
    }
}
