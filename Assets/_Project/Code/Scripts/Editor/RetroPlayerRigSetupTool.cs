...
{
    private const string DefaultPrefabPath = "Assets/_Project/Content/Actors/Player/Prefabs/Player.prefab";
    private const string InputActionsPath = "Assets/_Project/Settings/InputSystem_Actions.inputactions";
    private const string NoFrictionMaterialPath = "Assets/_Project/Settings/PlayerNoFriction.physicMaterial";
    private const string GunMaterialPath = "Assets/_Project/Art/Sprites/Gun.mat";
