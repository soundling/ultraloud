...
{
    private const string FramesFolderPath = "Assets/_Project/Art/Sprites/NPCs/SkeletonMotocross/Frames";
    private const string GeneratedFolderPath = "Assets/_Project/Art/Sprites/NPCs/SkeletonMotocross/Generated";
    ...
    public static void BuildOrReplace()
    {
        ...
        {
            Debug.LogError("Skeleton motocross folders are missing. Expected Frames and Generated folders under Assets/_Project/Art/Sprites/NPCs/SkeletonMotocross.");
            return;
        }
